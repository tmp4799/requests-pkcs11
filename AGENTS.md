...
read natively by the coding agent (Claude Code reads `CLAUDE.md`; other tools read this
mirror, `AGENTS.md`). There is nothing to install beyond `bd` (beads).
...
> This file is a verbatim mirror of `CLAUDE.md`. Edit both together.
